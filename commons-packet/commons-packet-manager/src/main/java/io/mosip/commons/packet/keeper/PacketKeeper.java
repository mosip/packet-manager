...
public class PacketKeeper {
     ...
     * @return : Packet
     */
    @Cacheable(value = "packets", key = "'zip-'.concat(#packetInfo.id).concat('-').concat(#packetInfo.packetName).concat('-').concat(#packetInfo.source).concat('-').concat(#packetInfo.process)", unless = "#result == null")
